...
public class MainActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.logout) {
            ...
            finish();
        } else if (id == R.id.edugov) {
            Intent browserIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("http://edu.gov.kz"));
    ...
    public void onDateSelected(MaterialCalendarView widget, CalendarDay date, boolean selected) {
        ...
        i.putExtra("cDate", android.text.format.DateFormat.format("dd/MM/yyyy", date.getDate()));
        startActivity(i);
    }
